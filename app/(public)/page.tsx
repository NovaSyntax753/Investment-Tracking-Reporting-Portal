        ...
        <div className="relative mx-auto max-w-5xl px-6 text-center">
          ...
          <HeroItem delay={0.2}>
            <p className="mx-auto mt-6 max-w-2xl text-lg text-muted-foreground">
              RK Trading offers curated equity and derivatives strategies with a focus on
          ...
          <Stagger className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {features.map((f) => (
              <StaggerItem key={f.title}>
                <Card className="bg-charcoal border-gold/20 hover:border-gold/40 transition-all hover:-translate-y-1 hover:shadow-[0_0_20px_rgba(212,175,55,0.12)] h-full">
      ...
      <section className="py-24 bg-navy-deep">
        <FadeUp className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-muted-foreground">
            Reach out to learn more about how RK Trading can work for your financial goals.
          </p>
