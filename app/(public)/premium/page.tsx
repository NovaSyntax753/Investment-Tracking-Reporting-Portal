...
import { CheckCircle2, TriangleAlert, Loader2, Mail, Phone, Instagram, MapPin, Crown, ShieldCheck, Clock3 } from 'lucide-react'
...
export default function PremiumPage() {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting }, reset } = useForm<PremiumContactFormData>({
    ...
    <div className="py-24">
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="mb-10 grid gap-8 lg:grid-cols-3">
          ...
          <Card className="bg-charcoal border-gold">
            ...
            <CardContent className="space-y-3 text-lg">
              <p><span className="text-muted-foreground">Monthly Subscription Fee:</span> <span className="font-semibold">₹3000</span></p>
        ...
        <FadeUp className="mt-12 text-center">
          <h3 className="text-3xl font-bold text-gold">Join Premium Now - ₹3000/month</h3>
        ...
        <div className="relative mt-20 overflow-hidden rounded-3xl border border-gold/30 bg-gradient-to-br from-[#0b1226] via-[#121a35] to-[#090f21] p-6 sm:p-10">
          ...
          <FadeUp className="mb-10 text-center">
            ...
            <h2 className="text-4xl font-extrabold sm:text-5xl">Private Support for Premium Members</h2>
            <p className="mx-auto mt-4 max-w-3xl text-lg text-slate-300">
              This priority channel is designed for premium members who want faster onboarding help,
              subscription support, and direct assistance before joining.
            </p>
          </FadeUp>
          ...
          <div className="grid gap-8 lg:grid-cols-5">
                  ...
                  <StaggerItem>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-300">Dedicated handling for premium membership requests.</p>
                      </div>
                    </div>
                  </StaggerItem>
                  <StaggerItem>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-300">We prioritize replies from this premium desk.</p>
                      </div>
                    </div>
                  </StaggerItem>
                </Stagger>
            ...
            <div className="lg:col-span-3">
              <Card className="border-gold/40 bg-gradient-to-b from-[#121d3a] to-[#0c1429] shadow-[0_0_45px_rgba(212,175,55,0.15)]">
                <CardHeader>
                  <CardTitle className="text-2xl text-gold">Request Premium Membership Assistance</CardTitle>
                </CardHeader>
                <CardContent>
                  {sent ? (
                    <div className="flex flex-col items-center gap-4 py-8 text-center">
                      <CheckCircle2 className="h-14 w-14 text-emerald-400" />
                      <p className="text-xl font-semibold">Premium Request Sent</p>
                      <p className="text-base text-slate-300">Our premium desk will contact you shortly.</p>
                      <Button variant="outline" className="mt-2 border-gold/50 bg-gold/10" onClick={() => setSent(false)}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                      <div className="space-y-1.5">
                        <Label htmlFor="name" className="text-base text-slate-100">Full Name</Label>
                        <Input
                          id="name"
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="email" className="text-base text-slate-100">Email Address</Label>
                        <Input
                          id="email"
                          type="email"
                      ...
                      <div className="space-y-1.5">
                        <Label htmlFor="message" className="text-base text-slate-100">Message</Label>
                        <Textarea
                          id="message"
                          rows={5}
              ...
              <div className="mt-6 grid gap-6 md:grid-cols-2">
                <Card className="border-gold/30 bg-[#101a34]/90">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-xl text-gold">Premium Contact Desk</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-start gap-3">
                      <Mail className="mt-0.5 h-5 w-5 text-gold" />
                      <a href={`mailto:${CONTACT_EMAIL}`} className="text-slate-300 transition-colors hover:text-gold">
                        {CONTACT_EMAIL}
                      </a>
                    </div>
                    <div className="flex items-start gap-3">
                      <Phone className="mt-0.5 h-5 w-5 text-gold" />
                      <a href="tel:+919588677762" className="text-slate-300 transition-colors hover:text-gold">
                        {CONTACT_PHONE}
                      </a>
                    </div>
                    <div className="flex items-start gap-3">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <p className="text-slate-300">Nagpur, Maharashtra, India</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="border-gold/30 bg-[#101a34]/90">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-xl text-gold">What Happens Next</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-3 text-slate-300">
                    <p>1. Premium desk reviews your request.</p>
                    <p>2. We share onboarding and payment details.</p>
                    <p>3. You receive private group access after confirmation.</p>
                  </CardContent>
                </Card>
              </div>
            </div>
