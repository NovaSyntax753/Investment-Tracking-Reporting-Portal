  ...
  return (
    <div className="py-20">
      <div className="mx-auto max-w-4xl px-6">
        ...
        {/* Bio */}
        <div className="mb-16 rounded-xl border border-gold/20 bg-charcoal p-8">
          <div className="flex flex-col items-start gap-6 md:flex-row">
            ...
            <div>
              <h2 className="text-2xl font-bold">AlphaCapital Fund Management</h2>
        ...
        {/* Values */}
        <div>
          <h2 className="mb-8 text-center text-2xl font-bold">Our Investment Philosophy</h2>
          <div className="grid gap-5 sm:grid-cols-2">
            {values.map((v) => (
              <Card key={v.title} className="bg-charcoal border-gold/20">
